...
public class QiniuCloudUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "7kzuv5YxLdsjJZr1wJDC7ay8wTHG22PNdaRCg_kW";
    private static final String SECRET_KEY = "pTlSe0JRBPHeKIsspNDYLTs2vI2eDHmvVvND7ctv";

    // 要上传的空间
    private static final String bucketname = "xiashudior";

    // 密钥
    private static final Auth auth = Auth.create(ACCESS_KEY, SECRET_KEY);

    private static final String DOMAIN = "http://q7xvatz7b.bkt.clouddn.com/";
